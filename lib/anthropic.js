 ...
 */
export async function draftIssue({ selection, mode, date, dailyUpdate, cta }) {
  ...
  const user = [
    ...
    '',
    '=== THE ONE CTA FOR THIS ISSUE ===',
    'This issue drives to exactly ONE offer. Write `theMove` so it leads naturally',
    'into this exact offer. Do NOT invent a different offer, and do NOT put any',
    'other link in the body. The button label and URL are set by the system, so',
    'you do not output them; you only write the sentence that earns the click.',
    `  Offer label : ${cta ? cta.label : '(none)'}`,
    `  What it is  : ${cta ? cta.blurb : '(none)'}`,
    '',
